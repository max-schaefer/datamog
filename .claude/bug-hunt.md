...
### 10b. Quoted identifiers (`QUOTED_IDENT`) put arbitrary chars into SQL identifiers and string literals
...
### 10c. Query-body validation is a near-duplicate of rule-body validation and drifts
...
### 10d. Parsers that "skip rather than corrupt" must apply that rule to every malformed shape
...
### 10. Field-presence checks on parsed user objects must use `Object.hasOwn`, not `in`
